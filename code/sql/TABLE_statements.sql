...
SELECT --- patient data
	...
	CASE WHEN DEATHDATE IS NULL AND COVID_FLAG = '1' THEN 0 ELSE 1 END AS COVID_DECEASED,
	CASE WHEN DEATHDATE IS NOT NULL AND COVID_FLAG = '1' THEN 0 ELSE 1 END AS COVID_ALIVE,
	--- ages
...
WHERE conditions.CODE <> '72892002' AND conditions.CODE <> '19169002' 
;
